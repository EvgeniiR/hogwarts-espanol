...
// Keys live in storage under `hp_creds` as {groq, gemini, anthropic, last}.
import { R } from './state.js';
import { kvGet, kvSet } from './storage.js';

export const KEY_INPUT_ID={anthropic:'apiKeyInput',gemini:'geminiKeyInput',groq:'groqKeyInput'};
...
export function setProvider(p){
  R.provider=p;
  ['anthropic','gemini','groq'].forEach(k=>{
